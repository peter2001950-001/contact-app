...
{
    public abstract class BaseRetireHandler<TType, TRequest, TOut> : IRequestHandler<TRequest, TOut> where TType : Entity, IRetirable where TRequest : IRequest<TOut>, IIdentifiable where TOut : class
    {
        protected readonly IMapper mapper;
        protected readonly ApplicationDbContext dbContext;

        protected BaseRetireHandler(ApplicationDbContext dbContext, IMapper mapper)
        {
